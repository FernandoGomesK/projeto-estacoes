...
function calcula_estacao()
{
    ...
    // define toda as imagens com estas configurações 
    estacoes.forEach(div => {
        div.style.transform = "scale(1)";
        div.style.opacity = "0.5";
    });
    // destaca a imagem para cada estação
    const divDestacar = document.querySelector(`.estacao.${estacao}`);

    if (divDestacar) {
        divDestacar.style.transform = "scale(1.2)";
        divDestacar.style.opacity = "1";
        divDestacar.style.borderRadius = "10px";
    }
